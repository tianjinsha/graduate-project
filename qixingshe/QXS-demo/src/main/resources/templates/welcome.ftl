...
<html>
    ...
    <body>
    <div class="x-body layui-anim layui-anim-up" style="width: 100%">
            ...
            <div class="layui-field-box">
                <table class="layui-table">
                    <tbody>
                        ...
                        <tr>
                            <th>开发者</th>
                            <td>田金山(tjstjswww@163.com)</td></tr>
                    </tbody>
                </table>
            </div>
        </fieldset>
        <blockquote class="layui-elem-quote layui-quote-nm">联系我们-cal123。</blockquote>
    </div>
