        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="L_id" name="id" required=""
                       autocomplete="off" class="layui-input" value="${liveTopic.id}" readonly>
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="L_name" name="cname" required="" lay-verify="Category_name"
                       autocomplete="off" class="layui-input" value="${liveTopic.cname}">
            </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                 <textarea name="description" placeholder="请输入内容" id="L_description" lay-verify="Category_description"
                           class="layui-textarea">${liveTopic.description}</textarea>
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">
            </label>
            <button class="layui-btn" lay-filter="liveTopic_edit" lay-submit>
                修改
            </button>
        </div>
    </form>
