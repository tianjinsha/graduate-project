...
<div class="x-body">
    ...
    <xblock>
        ...
        <button class="layui-btn" onclick="x_admin_show('添加用户','/itTags/add',600,400)"><i class="layui-icon"></i>添加</button>
    ...
    <table class="layui-table">
        ...
        <tr>
            <td>
                <div class="layui-unselect layui-form-checkbox" lay-skin="primary" data-id='${itTags.id}'><i class="layui-icon">&#xe605;</i></div>
            </td>
            <td>${itTags.id}</td>
            <td>${itTags.tname}</td>
