...
<div class="x-body">
    ...
    <table class="layui-table">
        ...
        <tr>
            ...
            <td>${awareTags.description}</td>
            <td>${(awareTags.attentionCount)!''}</td>
...
<@cast.page current=awareTagsList.current total=awareTagsList.total pages=awareTagsList.pages showPages=2 url=url/>
