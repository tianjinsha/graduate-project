...
<div class="x-body">
    <form class="layui-form">
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="name" name="name" required="" lay-verify="role_name"
                       autocomplete="off" class="layui-input" value="${managerRole.id}" readonly>
            </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="name" name="name" required="" lay-verify="role_name"
                       autocomplete="off" class="layui-input" value="${managerRole.name}">
            </div>
            <div class="layui-form-mid layui-word-aux">
                <span class="x-red">*</span>
            </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="identity" name="identity" required="" lay-verify="role_identity"
                       autocomplete="off" class="layui-input" value="${managerRole.identity}">
            </div>
            <div class="layui-form-mid layui-word-aux">
                <span class="x-red">*</span>
            </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                 <textarea name="description" placeholder="请输入内容" id="L_description" lay-verify="role_description"
                           class="layui-textarea">${managerRole.description}</textarea>
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <button class="layui-btn" lay-filter="managerRole-edit" lay-submit="">
                增加
            </button>
        </div>
    </form>
