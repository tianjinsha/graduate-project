    ...
    <div class="member-container content-wrap">
      ...
      <ul class="member-wrap  content-wrap">
        <li class="member-wrap-item" @click="memberEdit($event)">
          ...
          <div class="msg">
            <div class="msg-item"><span>姓名：</span>张雪婷</div>
            <div class="msg-item"><span>性别：</span>女</div>
            <div class="msg-item"><span>年龄：</span>23</div>
            <div class="msg-item"><span>卡号：</span>232425</div>
            <div class="msg-item"><span>热度：</span>3.7</div>
          </div>
        ...
        <li class="member-wrap-item">
          <div class="number"><span>222</span></div>
          <img class="member-img" src="../../assets/img/member2.jpg">
          <div class="msg">
            <div class="msg-item"><span>姓名：</span>张雪婷</div>
            <div class="msg-item"><span>性别：</span>女</div>
            <div class="msg-item"><span>年龄：</span>23</div>
